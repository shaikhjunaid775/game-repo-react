...
function Wallet() {
  const games = [
    { id: 1, name: "Lottery", amount: 0.00 },
    { id: 2, name: "TB_Chess", amount: 0.00 },
    { id: 3, name: "Wickets9", amount: 0.00 },
    { id: 4, name: "CQ9", amount: 0.00 },
    { id: 5, name: "MG", amount: 0.00 },
    { id: 6, name: "JDB", amount: 0.00 },
    { id: 7, name: "DG", amount: 0.00 },
    { id: 8, name: "CMD", amount: 0.00 },
    { id: 9, name: "SaBa", amount: 0.00 },
    { id: 10, name: "IM", amount: 0.00 },
    { id: 11, name: "EVO_Video", amount: 0.00 },
    { id: 12, name: "JILI", amount: 0.00 },
    { id: 13, name: "Card365", amount: 0.00 },
    { id: 14, name: "V8Card", amount: 0.00 },
    { id: 15, name: "AG_Video", amount: 0.00 },
    { id: 16, name: "PG", amount: 0.00 },
    { id: 17, name: "WM_Video", amount: 0.00 },
    { id: 18, name: "TB", amount: 0.00 }
  ];
  const value = 0.7;
  return (
    <>
      <div className="">
        <div className="overflow-x-hidden">
          <div className="relative top-0 h-[200px] w-[100%]  bg-gradient-to-r from-[#FF9A02] to-[#E67302]">
        ...
        <div className="mb-16">
          <div className="p-1.5 py-6 m-3 bg-white rounded-lg">
            <div className="flex justify-between">
              <div className="flex w-full flex-col text-center justify-center items-center">
                ...
                />
                <h4>₹0.000</h4>
                <h4 className="text-sm">Main wallet</h4>
              </div>
              <div className="flex w-full flex-col text-center justify-center items-center">
                <CircularProgressbar
                  className="w-20 font-bold "
            ...
            <div className="flex flex-col mx-auto bg-white  w-full">
              <div className="grid grid-cols-4 w-full min-w-0">
                <div className="flex flex-col p-2 text-center bg-white   overflow-hidden">
                  <Link to="/deposit">
                    <div className="flex justify-center">
                      <img src={deposit} alt="" />
                    </div>
                    <span className=" text-sm leading-none">Deposit</span>
                  </Link>
                </div>
                <div className="flex flex-col p-2 text-center bg-white   overflow-hidden">
                  <Link to="/withdraw">
                ...
                <div className="flex flex-col p-2 text-center bg-white leading-none  overflow-hidden">
                  <Link to="/account/depositHistory">
                    <div className="flex justify-center">
                      <img src={depositHistory} alt="" />
                    </div>
                ...
                <div className="flex flex-col p-2 text-center bg-white leading-none  overflow-hidden">
                  <Link to="/account/withdrawHistory">
                    <div className="flex justify-center">
            ...
            <div className=" mx-auto  w-full">
              <div className="grid grid-cols-3 gap-4">
                {games.map((items) => (
                  <div
                    key={items.id}
                    className="p-6 bg-white rounded-lg flex flex-col justify-center items-center gap-2"
                  >
