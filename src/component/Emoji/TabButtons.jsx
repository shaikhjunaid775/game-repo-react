...
function TabButtons({
  ...
  const handleMoodTabClick = (tabNumber2) => {
    setMoodtab(tabNumber2);
  };
    ...
    <>
          ...
          >
            ...
            >
              <div className="flex gap-1.5 flex-col items-center">
                ...
                <span className={`text-[11px] font-medium leading-none ${activeTab === 3 ? "white" : "#888EA4"} `}>
                  1 Min Mood
                </span>
              </div>
            </div>
      ...
      <div className="mt-3">
        ...
        >
          <div className="px-3 flex justify-between gap-7">
            <div className="flex flex-col w-2/4">
              <div className="flex gap-5 mb-1 items-center">
                <span className="inline-flex items-center gap-x-1.5 py-1.5 px-2 rounded-full text-xs font-medium bg-gradient-to-b from-[#2DA430] to-[#21C004] text-white  ">
                  <span className="size-2.5 inline-block rounded-full bg-white "></span>
                  LIVE
                </span>
          ...
          <div className="my-4">
            <ul
              className="px-2 grid grid-cols-5 gap-2 justify-between items-center text-sm font-medium text-center text-gray-50 rounded-[25px] bg-white py-3"
              aria-label="Tabs"
            >
              <li
              ...
              >
                <div
                  className={`p-1.5 rounded-full ${
                    moodtab === 1 ? "ring-1 ring-[#A5D4F8] " : ""
                  } `}
                  onClick={() => handleMoodTabClick(1)}
                >
                  <img
                ...
                <span className="text-black leading-none">1</span>
              </li>
              <li
                className={` rounded-full w-full transition-colors duration-300  flex flex-col items-center gap-1`}
              >
                <div
                  className={`p-1.5 rounded-full ${
                    moodtab === 2 ? "ring-1 ring-[#A5D4F8] " : ""
                  } `}
                  onClick={() => handleMoodTabClick(2)}
                >
                  <img
                    className={`rounded-full bg-gradient-to-tl from-gradient1 via-gradient2 to-gradient3  p-1.5 w-10`}
                    src={starStuck}
                ...
                <span className="text-black leading-none">2</span>
              </li>
              <li
                className={` rounded-full w-full transition-colors duration-300  flex flex-col items-center gap-1`}
              >
                <div
                  className={`p-1.5 rounded-full ${
                    moodtab === 3 ? "ring-1 ring-[#A5D4F8] " : ""
                  } `}
                  onClick={() => handleMoodTabClick(3)}
                >
                  <img
                    className={`rounded-full bg-gradient-to-tl from-gradient1 via-gradient2 to-gradient3  p-1.5 w-10`}
                    src={starStuck}
                ...
                <span className="text-black leading-none">3</span>
              </li>
              <li
                className={` rounded-full w-full transition-colors duration-300  flex flex-col items-center gap-1`}
              >
                <div
                  className={`p-1.5 rounded-full ${
                    moodtab === 4 ? "ring-1 ring-[#A5D4F8] " : ""
                  } `}
                  onClick={() => handleMoodTabClick(4)}
                >
                  <img
                    className={`rounded-full bg-gradient-to-tl from-gradient1 via-gradient2 to-gradient3  p-1.5 w-10`}
                    src={starStuck}
                ...
                <span className="text-black leading-none">4</span>
              </li>
              <li
                className={` rounded-full w-full transition-colors duration-300  flex flex-col items-center gap-1`}
              >
                <div
                  className={`p-1.5 rounded-full ${
                    moodtab === 5 ? "ring-1 ring-[#A5D4F8] " : ""
                  } `}
                  onClick={() => handleMoodTabClick(5)}
                >
                  <img
                    className={`rounded-full bg-gradient-to-tl from-gradient1 via-gradient2 to-gradient3  p-1.5 w-10`}
                    src={starStuck}
                ...
                <span className="text-black leading-none">5</span>
              </li>
            </ul>
          </div>
          <div className="my-4">
              ...
              <div className="flex justify-between px-2 gap-2 mb-3 items-center">
                ...
                <div className="relative">
                  <select className="border text-[#888EA4] border-gray-200 h-7 w-28   cursor-default rounded-md bg-white ps-6 text-left  shadow-sm  text-[11px]">
                    <option value="Monthly" className="">Monthly</option>
                    <option value="Yearly" className="">Yearly</option>
                  </select>
